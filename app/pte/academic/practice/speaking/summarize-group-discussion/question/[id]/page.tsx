    ...
    <div className="space-y-6">
      ...
      <div>
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
          Summarize Group Discussion Practice — Question {id?.slice(0, 8) || 'Unknown'}
        </h1>
        {question.difficulty && (
      ...
      <SpeakingQuestionClient questionId={id} questionType="summarize_group_discussion" />
...
export async function generateMetadata(props: Params) {
  ...
  const id = params.id
  return {
    title: `Summarize Group Discussion Practice — Question ${id?.slice(0, 8) || 'Unknown'}`,
